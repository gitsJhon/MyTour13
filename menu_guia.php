  ...
  <header>
    <nav class="nave">
      ...
      <ul>
        ...
        <li><a href="listacontratos.php" target="iframe_menu">Lista contratos</a></li>
        <li><a href="Contractospendientes.php" target="iframe_menu">Contractos pendiente</a></li>
        <li><a href="listraContacto.php" target="iframe_menu">Contactos</a></li>
        <li><a href="chat.php" target="iframe_menu">Chat</a></li>
