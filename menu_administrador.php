...
<body style="background-color: #fff; cursor: grab;">
  ...
  <header>  
    <nav class="nave">
      ...
      <ul>
        ...
        <li><a href="listaGrafitis.php" target="iframe_menu">Lista de Grafittis</a></li>
  ...
  <iframe name="iframe_menu" src="listareportes.php" frameborder="0" width="100%" height="85%" border:none;></iframe>
