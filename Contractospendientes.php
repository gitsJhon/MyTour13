    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Fecha de Fin</th>
                <th style=" background-color: #5dfff7;"><b style="color:red;">Cancelar</b></th>
            </tr>
        </thead>
        <tbody>
            <?php
                $select = mysqli_query($conexion, "SELECT * FROM contrato where id_guia = '$id' and estado ='aceptado'");
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="listacontratos.php" method="post">
                                    ...
                                    <button class="button1" type="submit" name="rechazar">Cancelar</button>
                                </form>
                            </td>
                        </tr>
                    <?php
...
<?php
    if (isset($_POST["rechazar"])) {
        $idUpdate = $_POST["id"];
        $update = mysqli_query($conexion, "UPDATE contrato SET estado = 'cancelado' where id_contrato = '$idUpdate'");
    }
?>